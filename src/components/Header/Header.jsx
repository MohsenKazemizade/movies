...
<header class="header_container__B2IBR" role="banner">
  <div class="header_inner__fSE9x">
    <div class="header_container__left__GPX29">
      <div
        id="nav-item--menu"
        class="header_nav-item__PWSg9 header_nav-item--menu__Kci1M "
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-16__Ab_82 button-base_secondary__N_MRW  button-base_empty__YOyMD header_nav-item--menu__button__I_Nz9    "
          aria-expanded="false"
          type="button"
        >
          <div class="button-base_inner__k9W0g">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
      ...
      <div
        id="nav-item--logo"
        class="header_nav-item__PWSg9 header_nav-item--logo__ZfDwA"
      >
        <button aria-label="Crackle Logo" type="button" data-submenu-index="0">
          <svg
            width="226"
            height="40"
            viewBox="0 0 226 40"
    ...
    <nav class="header_container__middle__zAGEw" role="navigation">
      <div
        id="nav-item--movies"
        class="header_container__middle__nav__uv5qs header_nav-item__PWSg9 header_nav-item--movies__efO_b  
          "
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-16__Ab_82 button-base_secondary__N_MRW  button-base_empty__YOyMD header_movies-button__guUAI    "
          id="movies_opener"
          aria-expanded="false"
          data-submenu-index="1"
          type="button"
      ...
      <div
        id="nav-item--shows"
        class="header_container__middle__nav__uv5qs header_nav-item__PWSg9 header_nav-item--shows__pleUj  "
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-16__Ab_82 button-base_secondary__N_MRW  button-base_empty__YOyMD header_tv-shows-button__uhvsY    "
          id="series_opener"
          aria-expanded="false"
          data-submenu-index="2"
          type="button"
      ...
      <div
        id="nav-item--watchlist"
        class="header_container__middle__nav__uv5qs header_nav-item__PWSg9 header_nav-item--watchlist__viXJq "
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-16__Ab_82 button-base_secondary__N_MRW  button-base_empty__YOyMD     "
          data-submenu-index="3"
          type="button"
        >
          <div class="button-base_inner__k9W0g">
    ...
    <div class="header_container__right__qpB9n">
      <div
        id="nav-item--search"
        class="header_container__right__nav__mZeNw header_nav-item__PWSg9 header_nav-item--search__Y1z7F "
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-16__Ab_82 button-base_secondary__N_MRW  button-base_empty__YOyMD     "
          data-submenu-index="4"
      ...
      <div
        id="nav-item--sign-up"
        class="header_container__right__nav__mZeNw header_nav-item__PWSg9 header_nav-item--sign-up__jpGVE"
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-14__ADzLo button-base_primary__2nq0a  button-base_solid__rqePh     "
          data-submenu-index="5"
          type="button"
        >
          <div class="button-base_inner__k9W0g">
      ...
      <div
        id="nav-item--sign-in"
        class="header_container__right__nav__mZeNw header_nav-item__PWSg9 header_nav-item--sign-in__ZOnNW"
      >
        <button
          class="button-base_outer__lo8Kr button-base_sm-32-14__ADzLo button-base_primary__2nq0a  button-base_transparent__d3kp_     "
          data-submenu-index="6"
          type="button"
        >
          <div class="button-base_inner__k9W0g">
